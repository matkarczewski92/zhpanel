...
style="height: 19rem; width: 90%; background: url('https://makssnake.pl/{{$animal->animalMainPhoto->url ?? 'public/Image/1_20241118051656.jpg'}}'); background-size: cover; background-position: center {{$animal->animalMainPhoto?->banner_possition ?? 10}}%; margin-top: -55px;">
        ...
        <div class="row h-100 ">
            <div class="col-8">
                <div class="position-relative top-50 start-0 translate-middle-y" style="margin-top: -10px;">
                    ...
                    <p class="h2 title fw-bold">@if ($animal->second_name)"{{$animal->second_name}}"@endif {{strip_tags($animal->name)}}</p>
